...
<!--
solid #6678b1 -->#hor-minimalist-a td {
	color: #ffffff;
	text-align: center;
}

#hor-minimalist-a tbody tr:hover td {<!--마우스 가져갈때 색상 --> color:#000000;
...
<body>
	<div id="main">
		...
		<div id="site_content">
			...
			<div id="content">
				...
				<div align="center">
					<font size="8" color="white">The Staff Information</font> <font
						size="8" color="white">Management System</font>
				</div>

				<div id="notice">
					<h1>NOTICE</h1>
					<input type="button" value="more"
						onclick="move('noticeServlet?command=notice_List');" />
				</div>
    ...
    --%>
						...
						<c:choose>
							<c:when test="${empty index_List}">
								<tr>
									<td colspan="2" align="center">공지사항이 없습니다.</td>
								</tr>
							</c:when>
							<c:otherwise>
								<c:forEach var="notice" items="${index_List}">
									...
									<input type="hidden" id="notno" value="${notice.notno}"> 
										...
										<%-- <td width="100" align="right">
											<!-- 날짜 yyyy-MM-dd형태로 파싱 --> <fmt:parseDate var="parseDate"
												value="${notice.notdate}" pattern="yyyyMMddHHmmss" /> <fmt:formatDate
												value="${parseDate}" pattern="yyyy-MM-dd" />
